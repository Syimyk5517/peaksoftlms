...
public class PresentationApi {
    ...
    public SimpleResponse updatePresentation(@RequestParam Long presentationId,@RequestBody @Valid PresentationRequest presentationUpdateRequest) {
        return presentationService.updatePresentation(presentationId,presentationUpdateRequest);
    }
